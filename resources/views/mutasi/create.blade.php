            ...
            <form action="/mutasi" method="POST">
                ...
                <div class="form-group">
                    ...
                    <select id="jenis" name="jenis" required>
                        ...
                        <option value="MASUK">✓ MASUK (Barang Masuk)</option>
                        <option value="KELUAR">✗ KELUAR (Barang Keluar)</option>
                    </select>
                    @error('jenis')
                        <small style="color: #e74c3c;">{{ $message }}</small>
                    @enderror
                ...
                <div class="form-group">
                    ...
                    <input type="number" id="jumlah" name="jumlah" placeholder="Contoh: 10" min="1" required>
                    @error('jumlah')
                        <small style="color: #e74c3c;">{{ $message }}</small>
                    @enderror
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="penanggung_jawab" name="penanggung_jawab" placeholder="Nama orang/tim yang bertanggung jawab" required>
                ...
                <div class="form-group">
                    ...
                    <textarea id="keterangan" name="keterangan" placeholder="Tambahkan catatan atau alasan mutasi..."></textarea>
                    @error('keterangan')
                        <small style="color: #e74c3c;">{{ $message }}</small>
                    @enderror
                </div>
