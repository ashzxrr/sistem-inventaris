...
<body>
    ...
    <div class="container">
        <div class="page-header">
            ...
            <p class="page-subtitle">Isi form di bawah untuk menambahkan barang ke inventaris</p>
        </div>
        ...
        <div class="form-card">
            <form action="/barang" method="POST">
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="nama_barang" name="nama_barang" placeholder="Contoh: Laptop Dell" required>
                    @error('nama_barang')
                        <small style="color: #e74c3c;">{{ $message }}</small>
                    @enderror
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="kategori" name="kategori" placeholder="Contoh: Elektronik" required>
                    @error('kategori')
                        <small style="color: #e74c3c;">{{ $message }}</small>
                    @enderror
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="satuan" name="satuan" placeholder="Contoh: Unit, Pcs, Meter" required>
                    @error('satuan')
                        <small style="color: #e74c3c;">{{ $message }}</small>
                    @enderror
                </div>
                ...
                <div class="form-group">
                    ...
                    <textarea id="keterangan" name="keterangan" placeholder="Tambahkan keterangan atau spesifikasi barang..."></textarea>
                    @error('keterangan')
                        <small style="color: #e74c3c;">{{ $message }}</small>
                    @enderror
                </div>
